...
class ConfigTests(unittest.TestCase):
    ...
    def test_load_settings_requires_source_chats_when_forwarding_enabled(self) -> None:
        self._set_base_env()
        os.environ["FORWARDING_ENABLED"] = "true"
        os.environ["TARGET_CHAT"] = "-100333"
        os.environ["BOT_TOKEN"] = "123:token"

        with self.assertRaisesRegex(ValueError, "SOURCE_CHATS"):
            load_settings(require_routing=True)
